    ...
    <div className="flex min-h-screen flex-col bg-zinc-50 dark:bg-zinc-950">
      ...
      <div className="flex flex-1 items-center justify-center px-6 py-16">
        <div className="w-full max-w-sm">
          ...
          {/* Card */}
          <div className="rounded-2xl border border-zinc-200 bg-white px-8 py-10 shadow-sm dark:border-zinc-800 dark:bg-black">
          ...
          <p className="mt-6 text-center text-xs leading-relaxed text-zinc-400 dark:text-zinc-600">
            ...
            <Link href="/terms" className="underline underline-offset-2 hover:text-black dark:hover:text-white">
              Terms of Service
            </Link>{" "}
            and{" "}
